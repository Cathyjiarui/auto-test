...
import com.puhui.bean.outsourcing.OutsourcingJobLog;
...
public interface OutsourcingJobLogMapper {
    @Delete({
        "delete from outsourcing_job_log",
        "where id = #{id,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long id);

    @Insert({
        "insert into outsourcing_job_log (id, create_time, ",
        "update_time, job_id, ",
    ...
    int insert(OutsourcingJobLog record);
    ...
    OutsourcingJobLog selectByPrimaryKey(Long id);

    @Update({
        "update outsourcing_job_log",
    ...
    int updateByPrimaryKey(OutsourcingJobLog record);
}